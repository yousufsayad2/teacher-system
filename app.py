...
def student_register():
    ...
    st.info(
        ...
        بعد التسجيل يمكنك الدخول في أي وقت
        ومتابعة حضورك.
        """
    )
...
def student_page():
    ...
    with tabs[0]:
        ...
        st.info(
            ...
            النظام سيعرف الحصة والصف والمجموعة
            تلقائيًا.
            """
        )
...
def teacher_dashboard():
    ...
    st.info(
        ...
        وبعدها يدخل بحسابه ويتابع حضوره
        ويمسح QR الحصص.
        """
    )
