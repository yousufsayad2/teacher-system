...
def analytics():
    ...
    st.info(
        "💡 هنا تقدر تعرف نسبة الحضور لكل صف، "
        "أكثر الطلاب حضورًا، الطلاب أصحاب الغياب الكثير، "
        "وإحصائيات كل مجموعة والبحث عن أي طالب."
    )
